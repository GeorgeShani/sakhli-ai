...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SakliAI is a hybrid PropTech/EduTech platform for Georgia, matching student flatmates and automating short-term rentals." },
      { property: "og:description", content: "SakliAI is a hybrid PropTech/EduTech platform for Georgia, matching student flatmates and automating short-term rentals." },
      { name: "twitter:description", content: "SakliAI is a hybrid PropTech/EduTech platform for Georgia, matching student flatmates and automating short-term rentals." },
