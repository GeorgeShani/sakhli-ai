...
const ZONES: Zone[] = [
  {
    ...
    insight:
      "Vake demand is exceptionally high due to the density of international universities and students. Suggested price: 1,750 GEL.",
  ...
  },
  {
    ...
    insight:
      "Saburtalo student demand is up 14% as a direct result of the new metro station and high density of private campuses.",
  ...
  },
  {
    ...
    insight:
      "Old Tbilisi tourist zone sees premium short-term demand up 22%. We suggest prioritization of SakhliAI hybrid rental leases.",
    insightKa:
      "ძველი თბილისი — მოკლევადიანი დაჯავშნებისთვის +22%. რეკომენდაცია: Airbnb პრიორიტეტი.",
  },
  {
    id: "rustavi",
    name: "Rustavi Center",
    ...
    insight:
      "Rustavi student demand has increased 18% due to affordable inter-city transport. Recommended price: 600 GEL.",
    insightKa:
      "რუსთავში სტუდენტური მოთხოვნა 18%-ით გაიზარდა ტრანსპორტის გამო. რეკომენდებული ფასი: 600 GEL.",
  },
];
    ...
    <div className="card-elevated p-5">
      <div className="mb-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 text-[11px] text-muted-foreground">
          ...
          <span className="flex items-center gap-1">
            <span className="h-2.5 w-2.5 rounded-full bg-orange-500" /> Med
          </span>
          <span className="flex items-center gap-1">
            <span className="h-2.5 w-2.5 rounded-full bg-amber-400" /> Low
          </span>
        </div>
      </div>
      ...
      <div className="relative h-64 overflow-hidden rounded-xl border border-border bg-gradient-to-br from-primary/5 via-accent/5 to-background">
        ...
        >
          <path
            d="M 0 55 Q 30 50 50 60 T 100 65"
            stroke="currentColor"
            strokeOpacity="0.15"
            strokeWidth="2"
            fill="none"
